                ...
                <ul className="flex flex-wrap gap-2" role="list">
                  {categorySkills.map((skill) => (
                    <li key={skill.name}>
                      <motion.span
                        className={cn(
                          "inline-flex cursor-default items-center rounded-md border border-zinc-800 bg-zinc-900/60 px-2.5 py-1 text-xs font-medium text-zinc-300",
                          "transition-colors duration-150 hover:border-zinc-600 hover:bg-zinc-800 hover:text-white"
                        )}
